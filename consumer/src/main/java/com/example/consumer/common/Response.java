...
import static com.example.consumer.common.ResponseCodeEnum.ERROR;
import static com.example.consumer.common.ResponseCodeEnum.SUCCESS;
...
public class Response<T> {
    ...
    public static Builder successBuilder() {
        return new Builder().code(SUCCESS.getCode()).msg(SUCCESS.getDescription());
    }
    ...
    public static Builder errorBuilder() {
        return new Builder().code(ERROR.getCode()).msg(ERROR.getDescription());
    }
